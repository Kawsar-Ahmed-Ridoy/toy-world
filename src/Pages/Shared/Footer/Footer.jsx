...
const Footer = () => {
  return (
    <footer className="footer  p-10 bg-black opacity-90  rounded text-gray-400 justify-around ">
      <div className="">
        <img src='https://i.ibb.co/VQzYXCz/Toy-World-Logo-01-scaled.jpg' className="h-20 mx-auto" alt="" />
        <div className="text-warning text-center">
        <p>Copyright &copy; 2023 - All right <br /> reserved by Toy World</p>
      </div>
      </div>
